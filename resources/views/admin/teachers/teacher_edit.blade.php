    ...
    <div class="container">
        <div class="row card border border-dark mt-4 my-shadow">
            <div class="d-flex align-items-center card-header card-header-color mb-3 border-bottom border-dark">
                ...
                <h4 class="ml-2 mt-2">Editar Professor(a)</h4>
            </div>
            <div class="body m-4">
                <form class="needs-validation" action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST">
                    @csrf
                    <input
                        type="hidden"
                        value="{{ $admin }}"
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <select name="class" id="inputEstado" class="form-control border-dark">
                                <option value="6" @if($teacher->class === '6') selected @endif>6º Ano</option>
                                <option value="7" @if($teacher->class === '7') selected @endif>7º Ano</option>
                                <option value="8" @if($teacher->class === '8') selected @endif>8º Ano</option>
                                <option value="9" @if($teacher->class === '9') selected @endif>9º Ano</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="form-row">
                        <div class="col-md-2 mb-3">
                            ...
                            <select name="roles" id="inputEstado" class="form-control border-dark">
                                <option value="TEACHER" @if($teacher->roles === 'TEACHER') selected @endif>Professor(a)</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
