            ...
            <div class="body m-4">
                <form enctype="multipart/form-data" class="needs-validation" action="{{ route('admin.questions.update', $question->id) }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between mt-5">
                        <div class="row ml-1">
                            <a class="btn my-btn-return border border-dark font-weight-bold" href="{{ route('admin.questions.index') }}">
                        ...
                        <div class="row mr-1">
                            ...
                            <a class="btn my-btn-delete border border-dark ml-1 font-weight-bold" href="{{ route('admin.questions.index') }}">
