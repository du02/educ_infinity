...
class QuestionController extends Controller
{
    ...
    {
        $user = Auth::id();
        $questions = Question::where('reference_id', $user)
            ->orderBy('id', 'desc')
            ->paginate(5);

        return view('teacher.questions.question_list', compact('questions'));
    }
    ...
    public function create()
    {
        ...
        return view('teacher.questions.question_create', compact('userID'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('teacher.questions.question_edit', compact('userID', 'question'));
    }
